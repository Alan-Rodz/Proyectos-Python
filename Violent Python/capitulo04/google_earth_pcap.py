...
#Este programa toma como argumento un archivo .pcap y produce un mapa .kml que luego podemos visualizar
#En dicho mapa se muestra el trafico del archivo .pcap
...
def dibujar_IPs(pcap):
    ...
    for ts, buf in pcap:
        try:
            ...
            src_kml = devolver_KML(src)
            dst_kml = devolver_KML(dst)
...
if __name__ == '__main__':
    ...
    with open(pcap_file, 'rb') as file:
        ...
        kmlheader = '<?xml version="1.0" encoding="UTF-8"?>' \
                    ...
                    '\n<Document>\n'
        kmlfooter = '</Document>\n</kml>\n'
        kmldoc = kmlheader + dibujar_IPs(_pcap) + kmlfooter
