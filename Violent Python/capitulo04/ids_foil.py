...
#Este programa genera alertas (falsas) faciles de detectar por un IDS 
#Posteriormente las envia en la cantidad que especifiquemos a la direccion que especifiquemos (desde una spoofed source)
...
def prueba_scan(src, dst, iface, count):
...
if __name__ == '__main__':
    ...
    prueba_ddos(_src, _dst, _iface, _count)
    prueba_exploit(_src, _dst, _iface, _count)
    prueba_scan(_src, _dst, _iface, _count)
